# Generated by Django 4.2.9 on 2024-08-13 20:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ConfiguracionDiseno',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(default='default', max_length=255)),
                ...
                ('fuente', models.CharField(default='Arial', max_length=255)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='logos/')),
                ('imagen_fondo', models.ImageField(blank=True, null=True, upload_to='fondos/')),
            ],
        ),
        migrations.CreateModel(
            name='Cupon',
