...
urlpatterns = [
    ...
    path('escanear-codigo-qr/', views.escanear_codigo_qr, name='escanear_codigo_qr'),
    ...
    path('actualizar-metodo-pago/', views.actualizar_metodo_pago, name='actualizar_metodo_pago'),
    path('iniciar-pago/<int:order_id>/', views.iniciar_pago, name='iniciar_pago'),
    path('webpay-plus/commit/', views.confirmar_pago, name='confirmar_pago'),
    path('pago-exitoso/', views.pago_exitoso, name='pago_exitoso'),
    path('pago-fallido/', views.pago_fallido, name='pago_fallido'),
    path('cambiar-contraseña/', PasswordChangeView.as_view(template_name='cambiar_contraseña.html'), name='password_change'),
    path('vista-previa-carrito/', vista_previa_carrito, name='vista_previa_carrito'),
    path('remove-cart-item/<int:item_id>/', remove_cart_item, name='remove_cart_item'),
    path('fetch-comunas/', fetch_comunas, name='fetch_comunas'),
    path('get-comunas/', get_comunas, name='get_comunas'),
    path('comprar-como-invitado/', views.comprar_como_invitado, name='comprar-como-invitado'),
    path('compra-invitado/', compra_invitado, name='compra_invitado'),
